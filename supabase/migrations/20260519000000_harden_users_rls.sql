-- =============================================
-- Migration: Harden Users Row Level Security (RLS)
-- Path: AL Prospect Finder Web App/supabase/migrations/20260519000000_harden_users_rls.sql
-- Description: Establishes enterprise-grade, role-based protection for the public.users table.
-- =============================================
